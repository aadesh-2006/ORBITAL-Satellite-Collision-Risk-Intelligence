...
export const OurPlanM5Placeholder: React.FC = () => {
      ...
      <ParallaxLayer depth={12}>
        ...
        >
          <FadeIn direction="down" distance={10} duration={0.8}>
            <StatusBadge
              label="STAGE 04 // OUR PLAN & ARCHITECTURE"
              variant="emerald"
            />
          </FadeIn>
          ...
          <FadeIn direction="up" distance={12} duration={0.8} delay={0.2}>
            ...
            >
              [ M5 MODULE TARGET — STANDING BY ]
            </div>
          </FadeIn>

          <FadeIn direction="up" distance={10} duration={0.8} delay={0.3}>
            <button
              onClick={() => goToStage('OUR_THINKING')}
              style={{
                marginTop: '28px',
