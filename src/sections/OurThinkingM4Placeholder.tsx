...
export const OurThinkingM4Placeholder: React.FC = () => {
      ...
      <ParallaxLayer depth={12}>
        ...
        >
          ...
          <FadeIn direction="up" distance={12} duration={0.8} delay={0.2}>
            ...
            >
              [ M4 MODULE TARGET — STANDING BY ]
            </div>
          </FadeIn>

          <FadeIn direction="up" distance={10} duration={0.8} delay={0.3}>
            <button
              onClick={() => goToStage('CONJUNCTION')}
              style={{
                marginTop: '28px',
