...
export const ConjunctionM3Placeholder: React.FC = () => {
      ...
      <ParallaxLayer depth={12}>
        ...
        >
          <FadeIn direction="down" distance={10} duration={0.8}>
            <StatusBadge
              label="STAGE 02 // CLOSE APPROACH CONJUNCTION"
              variant="ruby"
            />
          </FadeIn>
