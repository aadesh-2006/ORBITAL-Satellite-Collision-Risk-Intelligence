...
export const ModelM7Placeholder: React.FC = () => {
      ...
      <ParallaxLayer depth={12}>
        ...
        >
          <FadeIn direction="down" distance={10} duration={0.8}>
            <StatusBadge
              label="STAGE 06 // PROPOSED AI ARCHITECTURE"
              variant="emerald"
            />
          </FadeIn>
          ...
          <FadeIn direction="up" distance={12} duration={0.8} delay={0.2}>
            ...
            >
              [ M7 MODULE TARGET — STANDING BY ]
            </div>
          </FadeIn>

          <FadeIn direction="up" distance={10} duration={0.8} delay={0.3}>
            <button
              onClick={() => goToStage('OUR_APPROACH')}
              style={{
                marginTop: '28px',
